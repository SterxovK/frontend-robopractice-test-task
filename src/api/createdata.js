...
// join()Метод создает и возвращает новую строку путем объединения всех элементов в массиве (или массивоподобном объекте), разделенных запятыми или указанной строкой-разделителем.
